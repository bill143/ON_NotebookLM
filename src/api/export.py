...
async def export_content(
    ...
    from src.core.nexus_export_engine import (
        export_engine, ExportContent, ExportOptions, ExportFormat,
    )
...
async def list_formats():
    ...
    return {
        "formats": [
            ...
            {"id": "docx", "name": "Word (DOCX)", "mime": "application/vnd.openxmlformats-officedocument.wordprocessingml.document", "icon": "📝"},
